...
execute if score $day Time matches 1.. run execute if predicate hardcore:10day run title @a title [{"text":"Day ","bold":true,"color":"red"},{"score":{"objective":"Time","name":"$day"},"bold":true,"color":"red"}]
